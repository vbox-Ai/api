...
# vbox 内置默认 IPTV 直播源（无需外部配置）
DEFAULT_LIVES = [
    {"name": "fanmingming-IPv6", "url": "https://live.fanmingming.com/tv/m3u/ipv6.m3u"},
    {"name": "fanmingming-Global", "url": "https://live.fanmingming.com/tv/m3u/global.m3u"},
    {"name": "fanmingming-ITV", "url": "https://live.fanmingming.com/tv/m3u/itv.m3u"},
]
...
class Spider(BaseSpider):
    ...
    def init(self, extend):
        ...
        if not raw_lives:
            raw_lives = DEFAULT_LIVES
            self.logger.log("使用内置默认IPTV直播源（fanmingming）")
        lives = []
        name_counter = {}
