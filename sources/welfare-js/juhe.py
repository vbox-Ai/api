...
class Spider(Spider):
    ...
    def _fetch_text(self, url, timeout=8):
        """使用基类 self.fetch 获取文本，避免覆盖基类 fetch 方法"""
        try:
    ...
    def homeVideoContent(self):
        ...
        return self.categoryContent(first_key, 1, False, {})
