# -*- coding: utf-8 -*-
"""
黄豆短剧 vbox Python Spider — 纯 Python AES 适配版
站点: https://xqjzvcvt.top

vbox 适配：
1. pycryptodome/cryptography AES → 纯 Python AES-256-CBC（复用 fulao2.py 实现）
2. 域名注入 _vbox_effective_hosts
3. homeVideoContent 补全
    ...
    def init(self, extend=""):
        ...
        try:
            ...
            if effective_hosts and len(effective_hosts) > 0:
                ...
                print('[黄豆] 使用注入域名: ' + self.host)
        except Exception as e:
            print('[黄豆] 读取注入域名失败: ' + str(e))
